...
\title{\huge New Tools for Bayesian Experimental Design} % Poster title
...
\newcommand{\leftfoot}{lbry://url-of-this-poster ...} % Left footer text
...
\begin{block}{Methods}
Nested Sampling is often presented as a method for evaluating marginal
likelihoods
\begin{align}
...
John Skilling (John Skilling), and Joshua Dawes (Auckland) for helpful
